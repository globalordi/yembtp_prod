(function () {
  ...
  const dict = {
    ...
    'team.amanda_bubble':{ fr: 'À votre écoute pour bâtir une solution sur mesure, adaptée à votre budget.', en: 'Listening closely to build a tailored solution that fits your budget.' },
    'team.amanda_role':  { fr: 'Chargée d’affaires', en: 'Account Manager' },
    ...
    'team.aria_amanda':  { fr: 'Voir le message d’Amanda', en: 'See Amanda’s message' },
    ...
    'refs.lead':         { fr: 'Hôpitaux, parkings, équipements publics — YEMBTP intervient sur des sites sensibles avec un haut niveau de qualification.', en: 'Hospitals, car parks, public facilities — YEMBTP works on sensitive sites with a high level of qualification.' },
    'refs.c1_tag':       { fr: 'Parking', en: 'Car park' },
    'refs.c1_ba':        { fr: 'Avant / Après', en: 'Before / After' },
    ...
    'refs.c1_aria':      { fr: 'Ouvrir la galerie avant/après — Parking Michelet', en: 'Open the before/after gallery — Michelet Car Park' },
    'refs.hopital_tag':  { fr: 'Hôpital', en: 'Hospital' },
    'refs.c2_loc':       { fr: 'Île-de-France', en: 'Île-de-France' },
    'refs.c2_h':         { fr: 'Hôpital Avicenne', en: 'Avicenne Hospital' },
    'refs.c2_p':         { fr: 'Isolation des planchers bas par projection de produit fibreux, épaisseur 120 mm.', en: 'Low-floor insulation by sprayed fibrous product, 120 mm thickness.' },
    'refs.c2_spec':      { fr: '23 372 m² isolés · Ép. 120 mm', en: '23,372 sq.m insulated · 120 mm thick' },
    'refs.c3_loc':       { fr: 'Île-de-France', en: 'Île-de-France' },
    'refs.c3_h':         { fr: 'Hôpital René Muret', en: 'René Muret Hospital' },
    'refs.c3_p':         { fr: 'Isolation des planchers bas par projection de produit fibreux, épaisseur 120 mm.', en: 'Low-floor insulation by sprayed fibrous product, 120 mm thickness.' },
    'refs.c3_spec':      { fr: '8 900 m² isolés · Ép. 120 mm', en: '8,900 sq.m insulated · 120 mm thick' },
    'refs.c4_tag':       { fr: 'Hôpital · Metz', en: 'Hospital · Metz' },
    'refs.c4_loc':       { fr: 'Metz', en: 'Metz' },
    'refs.c4_h':         { fr: 'Hôpital Legouest', en: 'Legouest Hospital' },
    'refs.c4_p':         { fr: 'Isolation des planchers bas et calorifugeage des tuyauteries Eau Chaude, Chauffage et ECS.', en: 'Low-floor insulation and lagging of hot-water, heating and DHW piping.' },
    'refs.c4_spec':      { fr: '15 000 m² · 13 950 ml de tuyauteries', en: '15,000 sq.m · 13,950 lin.m of piping' },
    'refs.c5_tag':       { fr: 'Hôpital militaire', en: 'Military hospital' },
    'refs.c5_loc':       { fr: 'Hôpital militaire', en: 'Military hospital' },
    'refs.c5_h':         { fr: 'Hôpital Percy', en: 'Percy Hospital' },
    'refs.c5_p':         { fr: 'Calorifugeage des tuyauteries Eau Chaude, Chauffage et Eau Chaude Sanitaire.', en: 'Lagging of hot-water, heating and domestic hot-water piping.' },
    'refs.c5_spec':      { fr: '7 000 ml de tuyauteries traitées', en: '7,000 lin.m of piping treated' },
    ...
    // BA MODAL (Parking Michelet)
    'ba.close':          { fr: 'Fermer la fenêtre', en: 'Close window' },
    'ba.eyebrow':        { fr: 'Référence chantier · La Défense', en: 'Project · La Défense' },
    'ba.title':          { fr: 'Parking Michelet <em>— avant / après</em>', en: 'Michelet Car Park <em>— before / after</em>' },
    'ba.desc':           { fr: 'Application de flocage coupe-feu sur l’ensemble des structures porteuses du parking. Glissez la poignée centrale pour comparer l’état initial et le traitement final.', en: 'Fireproof spraying applied to all the load-bearing structures of the car park. Drag the central handle to compare the initial state and the final treatment.' },
    'ba.alt_after':      { fr: 'Parking Michelet — après application du flocage coupe-feu', en: 'Michelet Car Park — after fireproof spraying' },
    'ba.alt_before':     { fr: 'Parking Michelet — état initial avant intervention', en: 'Michelet Car Park — initial state before works' },
    'ba.label_before':   { fr: 'Avant', en: 'Before' },
    'ba.label_after':    { fr: 'Après', en: 'After' },
    'ba.stat1_lab':      { fr: 'Flocage coupe-feu', en: 'Fireproof spraying' },
    'ba.stat2_lab':      { fr: 'Conformité réglementaire', en: 'Regulatory compliance' },
    'ba.stat3_lab':      { fr: 'Tenue au feu garantie', en: 'Guaranteed fire resistance' },
